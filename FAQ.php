            ...
            <li class="nav-item">
                ...
                <div id="collapse3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="add_php">Add </a>
                    </div>
                </div>
            </li>
			<li class="nav-item">
...
<tbody>
                 <tr>
                    ...
                    <td><a class="btn btn-outline-danger" href='userdelete.php?key1=<?php echo $row["id"]; ?>'>Delete</a>
                      <a class="btn btn-outline-success" href='userdelete.php?key1=<?php echo $row["id"]; ?>'>Approve</a>
                    </td>
