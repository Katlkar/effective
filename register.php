    ...
    if (isset($_POST['username'])) {
        if (!empty($username) || !empty($email) || !empty($password)) {
            if (isset($_POST['password']) && $_POST['password'] !== $_POST['confirm_password']) {
                echo "<script type='text/javascript'>alert('The two passwords do not match!'); window.location.href = 'register.php';</script>";
            } else {
            ...
            <li class="nav-item">
                ...
                <div id="collapse3" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="add_club">Add </a>
                    </div>
                </div>
            </li>
			 <li class="nav-item">
