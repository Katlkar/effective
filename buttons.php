    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Campus Cauldron</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading --><div class="container">
	<div class="card crd">
	<div class="card-body text-center"><h3><b>YOUR ANSWER WILL APPEAR HERE</b> <hr id="after-notice" class="section-diff" style="width:65%">
</h3><textarea  class="area" name="Text1" cols="60" rows="6" placeholder="Your question here" id="ask-question"></textarea><br><br><div class="card-footer><a class="intro-link" href=""
	><h5 class="intro-link-head">Approve</h5></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	</div>
	</div></div>
